...
def test_empty_input_returns_empty_dict():
    assert weekly_capacity_rows_to_explicit_backward_capability([]) == {}


def test_happy_path_builds_product_node_capacity_type_week_capability_context():
    got = weekly_capacity_rows_to_explicit_backward_capability(
        [
...
def test_forward_backward_symmetry_for_same_weekly_capacity_rows():
    rows = [
        row(
